...
// pub fn scan_path(pattern: &str, path: &str) -> Result<(Vec<String>), Box<Error>> {
...
//                 //     buf: vec![],
//                 // };
//                 // let mut scan_matches = vec![];

//                 // let _ = searcher.search_path(
//                 //     &matcher,
//                 //     entry.path(),
//                 //     MatchesSink(|_searcher, sink_match| {
//                 //         println!("{:?}", sink_match);
//                 //         let line_number = sink_match.line_number().unwrap();
//                 //         // let line_bytes = sink_match.buffer().to_vec();
//                 //         let line_bytes = sink_match.bytes().to_vec();

//                 //         println!("{}", line_number); //debug

//                 //         matcher
//                 //             .find_iter(sink_match.bytes(), |_m| {
//                 //                 let scan_match = ScanMatch {
//                 //                     line_number: line_number,
//                 //                     line_bytes: line_bytes.clone(),
//                 //                     ranges: _m,
//                 //                 };
//                 //                 matche_count += 1;
...
//                 //         entry: entry,
//                 //         matche_count: matche_count,
//                 //         matche_data: scan_matches,
//                 //     };
